...
def interpolate_matrix(matrix):
    ...
    def interpolate_0_1(t):
        ...
        interval_offset = fractionalLocation-idx
        return intervals[idx](interval_offset)
    return interpolate_0_1


viridis = interpolate_matrix(np.array(_viridis_data))
magma = interpolate_matrix(np.array(_magma_data))
plasma = interpolate_matrix(np.array(_plasma_data))
inferno = interpolate_matrix(np.array(_inferno_data))
